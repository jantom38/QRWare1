...
class LocationsApi:
    ...
    def search(self, query: str) -> Tuple[bool, str, List[Dict[str, Any]]]:
        base = self.cfg.base_url.rstrip('/')
        url = f"{base}/api/locations/search"
        try:
    ...
    def update(self, loc_id: int, payload: Dict[str, Any]) -> Tuple[bool, str, Optional[Dict[str, Any]]]:
        base = self.cfg.base_url.rstrip('/')
        url = f"{base}/api/locations/{loc_id}"
        try:
    ...
    def delete(self, loc_id: int) -> Tuple[bool, str]:
        base = self.cfg.base_url.rstrip('/')
        url = f"{base}/api/locations/{loc_id}"
        try:
    ...
    def toggle_active(self, loc_id: int) -> Tuple[bool, str, Optional[Dict[str, Any]]]:
        base = self.cfg.base_url.rstrip('/')
        url = f"{base}/api/locations/{loc_id}/toggle-active"
        try:
